...
// this time intead of using the class we are gonna use 
// record type. because record types is very good for defining value
// objects in terms of the comparing and removing the id operations.  
